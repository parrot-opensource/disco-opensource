...
struct _GstV4l2Object {
  ...
  struct v4l2_ext_controls *extended_control;
  ...
  /* Never copy buffers if we are running low */
  gboolean disable_copy_threshold;

  /* minimum buffers to allocate/request from user */
  guint user_min_buffers;
};
...
#define V4L2_STD_OBJECT_PROPS \
    ...
    PROP_DISABLE_COPY_THRESHOLD, \
    PROP_MIN_BUFFERS,          \
    PROP_EXTENDED_CONTROLS
