...
test_schema_get_child_id (void)
{
  ...
  schema = g_settings_schema_source_lookup (src, "org.gtk.test", TRUE);
  g_assert (schema != NULL);

  id = g_settings_schema_get_child_schema_id (schema, "basic-types");
  g_assert_cmpstr (id, ==, "org.gtk.test.basic-types");
...
main (int argc, char *argv[])
{
  ...
  g_test_add_func ("/gsettings/schema-get-child-id", test_schema_get_child_id);
