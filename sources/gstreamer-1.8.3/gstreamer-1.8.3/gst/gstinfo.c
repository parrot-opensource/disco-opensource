...
/* Indicates that default log function was removed (possibly very early)
   so don't add it at init */
static gboolean default_log_func_removed = FALSE;
